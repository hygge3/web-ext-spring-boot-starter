...
/**
 * Array、List 对象方法参数解析器
 */
public class ArrayArgumentResolver extends AbstractNamedValueMethodArgumentResolver implements UriComponentsContributor {

    static final TypeDescriptor STRING_TYPE_DESCRIPTOR = TypeDescriptor.valueOf(String.class);
     ...
     *                             request parameter name is derived from the method parameter name.
     */
    public ArrayArgumentResolver(@Nullable ConfigurableBeanFactory beanFactory, boolean useDefaultResolution) {
        super(beanFactory);
        this.useDefaultResolution = useDefaultResolution;
    }
    ...
    protected Object resolveName(@NonNull String name, @NonNull MethodParameter parameter, NativeWebRequest request) throws Exception {
        ...
        if (arg == null) {
            ...
            if (param != null) {
                ...
                if (parameterType == JSONArray.class || actualTypeArgument == JSONArray.class) {
                ...
                } else if (!BeanUtils.isSimpleProperty(Objects.requireNonNull(actualTypeArgument)) && BeanUtil.isBean(actualTypeArgument)) {
                    ...
                    if (!verify && value != null && value.size() > 0) {
    ...
    @Override
    protected void handleMissingValue(@NonNull String name, @NonNull MethodParameter parameter, NativeWebRequest request) throws Exception {
    ...
    @Override
    @NonNull
    public void contributeMethodArgument(MethodParameter parameter, @Nullable Object value, @NonNull UriComponentsBuilder builder, @NonNull Map<String, Object> uriVariables, @NonNull ConversionService conversionService) {
        ...
        if (value == null) {
            if (requestParam != null && (!requestParam.required() || !ValueConstants.DEFAULT_NONE.equals(requestParam.defaultValue()))) {
                return;
            }
