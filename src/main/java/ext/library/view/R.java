...
public class R {
    ...
    public static Result<?> getResult(Throwable e) {
        ...
        } else if (ClassLoaderUtil.isPresent("feign.FeignException") && ClassLoaderUtil
                .loadClass("feign.FeignException").isAssignableFrom(e.getClass())) {
        ...
        } else if (ClassLoaderUtil.isPresent("org.mybatis.spring.MyBatisSystemException") && ClassLoaderUtil
                .loadClass("org.mybatis.spring.MyBatisSystemException").isAssignableFrom(e.getClass())) {
            try {
        ...
        } else if (ClassLoaderUtil.isPresent("cn.dev33.satoken.exception.NotLoginException") && ClassLoaderUtil
                .loadClass("cn.dev33.satoken.exception.NotLoginException").isAssignableFrom(e.getClass())) {
