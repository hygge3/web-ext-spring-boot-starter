...
public class RedisUtils {
     ...
     */
    public static <T> void publish(String channelKey, T msg, @NonNull Consumer<T> consumer) {
     ...
     */
    public static void delete(@NonNull Collection<?> collection) {
        RBatch batch = CLIENT.createBatch();
     ...
     * @param hKeys Hash 键
     */
    public static <T> void delMultiMapValue(final String key, @NonNull final Set<String> hKeys) {
        RBatch batch = CLIENT.createBatch();
